...
namespace TWB_Parser
{
    class CSVFileLine
    {
        ...
        public string P1Char1 { get; private set; }
        public string P1Char2 { get; private set; }
        public string P1Char3 { get; private set; }
        public string P2Name { get; private set; }
        public string P2Char1 { get; private set; }
        public string P2Char2 { get; private set; }
        public string P2Char3 { get; private set; }
        ...
        {
            if (string.IsNullOrWhiteSpace(aCurrentLine)) throw new ArgumentException("Error: The CSV line must not be null or empty.");
        ...
        private void ParseCSVLine()
        {
            try
            {
                ...
                if (!MatchDataEnumTool.RegionList.Contains(Region)) throw new FormatException("Unknown Region.");
                ...
                if (!MatchDataEnumTool.VersionList.Contains(Version)) throw new FormatException("Unknown Region.");

                P1Name = splittedLine[5];
                P1Char1 = MatchDataEnumTool.TestAndResolveCharacterName(splittedLine[6]);
                P1Char2 = MatchDataEnumTool.TestAndResolveCharacterName(splittedLine[7]);
                P1Char3 = MatchDataEnumTool.TestAndResolveCharacterName(splittedLine[8]);
                P2Name = splittedLine[9];
                P2Char1 = MatchDataEnumTool.TestAndResolveCharacterName(splittedLine[10]);
                P2Char2 = MatchDataEnumTool.TestAndResolveCharacterName(splittedLine[11]);
                P2Char3 = MatchDataEnumTool.TestAndResolveCharacterName(splittedLine[12]);
                URL = splittedLine[13];
